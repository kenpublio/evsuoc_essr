...
// Get survey questions for Registrar
...
// Get selected service from URL (coming from index.php)
$selected_service_id = isset($_GET['service_id']) ? (int)$_GET['service_id'] : 0;

// If no service selected, redirect back to index
...
$service_name = $service_names[$selected_service_id] ?? 'Service';
    ...
    <div class="main-container">
        ...
        <aside class="sidebar">
            ...
            <div class="info-card">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <i class="fas fa-tag"></i> <?php echo htmlspecialchars($service_name); ?>
                    </div>
                </div>
                <div class="info-item">
        ...
        <main class="content">
            ...
            <?php elseif (isset($success) && $success): ?>
                ...
                <div class="thank-you-card">
                    ...
                    <div class="service-badge">
                        <i class="fas fa-tag"></i> Service: <?php echo htmlspecialchars($service_name); ?>
                    </div>
            ...
            <?php else: ?>
                ...
                <!-- Service Info Card (Shows selected service) -->
                <div class="card service-info-card">
                    <h3>
                        <i class="fas fa-check-circle"></i>
                        Selected Service
                    </h3>
                    <p>You are evaluating the following service:</p>
                    <div class="service-name-badge">
                        <i class="fas fa-tag"></i> <?php echo htmlspecialchars($service_name); ?>
                    </div>
                    <input type="hidden" name="service_type" value="<?php echo $selected_service_id; ?>">
                </div>
                    ...
                    <div id="questionsSection" class="questions-section">
                        <div class="questions-container">
                            ...
                            <?php foreach ($questions as $index => $q): 
                                $num = $index + 1;
                                $question_text = is_array($q) ? ($q['question_text'] ?? $q) : $q;
                            ?>
                ...
                <script>
                    ...
                    function updateProgress() {
                        ...
                        let percentage = (answered / totalQuestions) * 75;
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        // Check if any ratings are already selected (for form resubmission)
                        for (let i = 1; i <= totalQuestions; i++) {
                            const selectedRating = document.querySelector('input[name="rating_' + i + '"]:checked');
                            if (selectedRating) {
                                updateRating(i, parseInt(selectedRating.value));
                            }
                        }
                    });
                </script>
